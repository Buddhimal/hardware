        ...
        <div id="block2"  class="form-group col-sm-1.5">
                    ...
                    <!-- <div class="input-group date" id="reservationtodate" data-target-input="nearest">
                        ...
                        <div class="input-group-append" data-target="#reservationtodate" data-toggle="datetimepicker">
                            ...
                            <div class="form-group col-sm-2">
                                <div class="input-group date" id="reservationtodate" data-target-input="nearest">
                                    <input type="text" id="to" name="to" class="form-control datetimepicker-input"
                    ...
                    <div class="form-group col-sm-2">
                        <select id="searchById" class="form-control select2bs4">
                            ...
                            <div class="form-group col-sm-1" style="flex:auto;">
                                <button id="btnSearch" type="submit" class="btn btn-block bg-gradient-secondary">Search
                                </button>
                            </div>
...
<!--                        </form>-->
                    ...
                    <div class="form-group col-sm-1" style="flex:auto;">
                        <button id="btnSearch" type="button" class="btn btn-block bg-gradient-secondary">Search</button>
                    </div>
                    <div class="form-group" style="flex:auto;">
